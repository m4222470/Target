...
/**
 * ProductDetails - Displays product information, features, and specifications
 * @param {Object} props
 * @param {Object} props.product - Product data from product.json
 */
  ...
  const renderStars = (rating) => {
    ...
    for (let i = 0; i < 5; i++) {
      if (i < fullStars) {
        ...
        stars.push(
          <Star key={i} className="w-5 h-5 text-neutral-300 dark:text-neutral-600" />
        );
      }
    }
    return stars;
